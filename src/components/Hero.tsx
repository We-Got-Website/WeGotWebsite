      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-5xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight">
          ...
          >
            ...
            <div className="bg-black/20 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden shadow-2xl relative z-10">
